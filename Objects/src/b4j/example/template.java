...
;
			...
			ba.setLastException(e23); //BA.debugLineNum = 165;BA.debugLine="App.throwError(LastException)";
...
public String  _app_genframe() throws Exception{
 //BA.debugLineNum = 170;BA.debugLine="Sub App_genFrame";
 //BA.debugLineNum = 171;BA.debugLine="If App.startedAt<DateTime.Now-App.duration*1000/2";
if (_app._getstartedat /*long*/ ()<__c.DateTime.getNow()-_app._getduration /*int*/ ()*1000/(double)2) { 
 //BA.debugLineNum = 172;BA.debugLine="App.genSimpleFrame(\"TMR:\"&secondDayLow&\"°~\"&seco";
_app._gensimpleframe /*String*/ ("TMR:"+_seconddaylow+"°~"+_seconddayhigh+"°",_seconddayicon,__c.False,__c.False,(int[])(__c.Null),__c.True);
 }else {
 //BA.debugLineNum = 174;BA.debugLine="App.genSimpleFrame(\"Today:\"&firstDayLow&\"°~\"&fir";
_app._gensimpleframe /*String*/ ("Today:"+_firstdaylow+"°~"+_firstdayhigh+"°",_firstdayicon,__c.False,__c.False,(int[])(__c.Null),__c.True);
 };
...
_app = new b4j.example.awtrix();
 //BA.debugLineNum = 4;BA.debugLine="Dim iconID As Int = 487";
_iconid = (int) (487);
 //BA.debugLineNum = 6;BA.debugLine="Dim firstDayHigh As String = \"0\"";
_firstdayhigh = "0";
 //BA.debugLineNum = 7;BA.debugLine="Dim firstDayLow As String = \"0\"";
_firstdaylow = "0";
 //BA.debugLineNum = 8;BA.debugLine="Dim firstDayIcon As Int = 487";
_firstdayicon = (int) (487);
 //BA.debugLineNum = 10;BA.debugLine="Dim secondDayHigh As String = \"0\"";
_seconddayhigh = "0";
 //BA.debugLineNum = 11;BA.debugLine="Dim secondDayLow As String = \"0\"";
_seconddaylow = "0";
 //BA.debugLineNum = 12;BA.debugLine="Dim secondDayIcon As Int = 487";
_seconddayicon = (int) (487);
 //BA.debugLineNum = 14;BA.debugLine="End Sub";
return "";
}
public short  _geticonid(int _weathercode) throws Exception{
 //BA.debugLineNum = 181;BA.debugLine="Sub getIconID (weatherCode As Int)As Short";
 //BA.debugLineNum = 182;BA.debugLine="If weatherCode>=0 And weatherCode<=3 Then";
if (_weathercode>=0 && _weathercode<=3) { 
 //BA.debugLineNum = 183;BA.debugLine="Return 349";
if (true) return (short) (349);
 }else if(_weathercode>=4 && _weathercode<9) { 
 //BA.debugLineNum = 185;BA.debugLine="Return 486";
if (true) return (short) (486);
 }else if(_weathercode>=10 && _weathercode<20) { 
 //BA.debugLineNum = 187;BA.debugLine="Return 346";
if (true) return (short) (346);
 }else if(_weathercode>=21 && _weathercode<25) { 
 //BA.debugLineNum = 189;BA.debugLine="Return 344";
if (true) return (short) (344);
 }else if(_weathercode>=27 && _weathercode<33) { 
 //BA.debugLineNum = 191;BA.debugLine="Return 313";
if (true) return (short) (313);
 }else {
 //BA.debugLineNum = 193;BA.debugLine="Return 467";
...
_app._setsettings(__c.createMap(new Object[] {(Object)("APIKey"),(Object)(""),(Object)("CityID"),(Object)("beijing")}));
...
_app._setdownloads((int) (1));
 //BA.debugLineNum = 64;BA.debugLine="App.Icons=Array(349,486,346,344,313,467)";
_app._seticons(anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(349),(Object)(486),(Object)(346),(Object)(344),(Object)(313),(Object)(467)}));
